...
const ankiVocab = [
    { hz: "的", py: "de", pt: "partícula de posse / 's" },
    { hz: "我", py: "wǒ", pt: "eu" },
    { hz: "你", py: "nǐ", pt: "você" },
    { hz: "是", py: "shì", pt: "ser / é" },
    { hz: "了", py: "le", pt: "partícula de mudança/passado" },
    { hz: "不", py: "bù", pt: "não" },
    { hz: "在", py: "zài", pt: "estar / em" },
    { hz: "他", py: "tā", pt: "ele" },
    { hz: "我们", py: "wǒmen", pt: "nós" },
    { hz: "好", py: "hǎo", pt: "bom / bem" },
    { hz: "有", py: "yǒu", pt: "ter" },
    { hz: "这", py: "zhè", pt: "este / isto" },
    { hz: "会", py: "huì", pt: "saber (fazer) / vai (futuro)" },
    { hz: "吗", py: "ma", pt: "partícula de pergunta" },
    { hz: "什么", py: "shénme", pt: "o que / qual" },
    { hz: "说", py: "shuō", pt: "falar" },
    { hz: "她", py: "tā", pt: "ela" },
    { hz: "想", py: "xiǎng", pt: "pensar / querer / sentir falta" },
    { hz: "一", py: "yī", pt: "um" },
    { hz: "很", py: "hěn", pt: "muito" },
    { hz: "人", py: "rén", pt: "pessoa" },
    { hz: "那", py: "nà", pt: "aquele / então" },
    { hz: "来", py: "lái", pt: "vir" },
    { hz: "都", py: "dōu", pt: "todos / ambos" },
    { hz: "个", py: "gè", pt: "classificador genérico" },
    { hz: "能", py: "néng", pt: "poder / ser capaz" },
    { hz: "去", py: "qù", pt: "ir" },
    { hz: "和", py: "hé", pt: "e / com" },
    { hz: "做", py: "zuò", pt: "fazer" },
    { hz: "上", py: "shàng", pt: "em cima / anterior / subir" },
    { hz: "没有", py: "méiyǒu", pt: "não ter / não haver" },
    { hz: "看", py: "kàn", pt: "olhar / ver / ler" },
    { hz: "怎么", py: "zěnme", pt: "como?" },
    { hz: "现在", py: "xiànzài", pt: "agora" },
    { hz: "点", py: "diǎn", pt: "hora / ponto / um pouco" },
    { hz: "呢", py: "ne", pt: "partícula (e você?)" },
    { hz: "太", py: "tài", pt: "demais / muito" },
    { hz: "里", py: "lǐ", pt: "dentro" },
    { hz: "听", py: "tīng", pt: "ouvir" },
    { hz: "谁", py: "shéi", pt: "quem" },
    { hz: "多", py: "duō", pt: "muito / quão" },
    { hz: "时候", py: "shíhou", pt: "momento / quando" },
    { hz: "下", py: "xià", pt: "embaixo / próximo / descer" },
    { hz: "谢谢", py: "xièxie", pt: "obrigado" },
    { hz: "先生", py: "xiānsheng", pt: "Sr. / marido" },
    { hz: "喜欢", py: "xǐhuan", pt: "gostar" },
    { hz: "大", py: "dà", pt: "grande" },
    { hz: "东西", py: "dōngxi", pt: "coisa" },
    { hz: "小", py: "xiǎo", pt: "pequeno" },
    { hz: "叫", py: "jiào", pt: "chamar-se / gritar" },
    { hz: "爱", py: "ài", pt: "amar" },
    { hz: "年", py: "nián", pt: "ano" },
    { hz: "请", py: "qǐng", pt: "por favor / convidar" },
    { hz: "回", py: "huí", pt: "voltar / responder" },
    { hz: "工作", py: "gōngzuò", pt: "trabalho / trabalhar" },
    { hz: "钱", py: "qián", pt: "dinheiro" },
    { hz: "吃", py: "chī", pt: "comer" },
    { hz: "开", py: "kāi", pt: "abrir / dirigir" },
    { hz: "家", py: "jiā", pt: "família / casa" },
    { hz: "哪", py: "nǎ", pt: "qual" },
    { hz: "朋友", py: "péngyou", pt: "amigo" },
    { hz: "妈妈", py: "māma", pt: "mãe" },
    { hz: "今天", py: "jīntiān", pt: "hoje" },
    { hz: "几", py: "jǐ", pt: "quantos (menos de 10)" },
    { hz: "爸爸", py: "bàba", pt: "pai" },
    { hz: "些", py: "xiē", pt: "alguns" },
    { hz: "怎么样", py: "zěnmeyàng", pt: "como é que é? / que tal?" },
    { hz: "对不起", py: "duìbuqǐ", pt: "desculpe" },
    { hz: "住", py: "zhù", pt: "morar" },
    { hz: "三", py: "sān", pt: "três" },
    { hz: "高兴", py: "gāoxìng", pt: "feliz" },
    { hz: "买", py: "mǎi", pt: "comprar" },
    { hz: "医生", py: "yīshēng", pt: "médico" },
    { hz: "哪儿", py: "nǎr", pt: "onde" },
    { hz: "字", py: "zì", pt: "caractere / palavra" },
    { hz: "名字", py: "míngzi", pt: "nome" },
    { hz: "认识", py: "rènshi", pt: "conhecer / saber" },
    { hz: "坐", py: "zuò", pt: "sentar" },
    { hz: "喝", py: "hē", pt: "beber" },
    { hz: "写", py: "xiě", pt: "escrever" },
    { hz: "月", py: "yuè", pt: "mês / lua" },
    { hz: "号", py: "hào", pt: "dia / número" },
    { hz: "狗", py: "gǒu", pt: "cachorro" },
    { hz: "岁", py: "suì", pt: "anos de idade" },
    { hz: "看见", py: "kànjiàn", pt: "ver / avistar" },
    { hz: "打电话", py: "dǎ diànhuà", pt: "telefonar" },
    { hz: "喂", py: "wèi", pt: "alô / ei" },
    { hz: "儿子", py: "érzi", pt: "filho" },
    { hz: "漂亮", py: "piàoliang", pt: "bonita" },
    { hz: "分钟", py: "fēnzhōng", pt: "minuto" },
    { hz: "再见", py: "zàijiàn", pt: "tchau / adeus" },
    { hz: "本", py: "běn", pt: "classificador para livros" },
    { hz: "明天", py: "míngtiān", pt: "amanhã" },
    { hz: "少", py: "shǎo", pt: "pouco" },
    { hz: "多少", py: "duōshao", pt: "quanto? (quantidade)" },
    { hz: "块", py: "kuài", pt: "pedaço / classificador de dinheiro (yuan)" },
    { hz: "女儿", py: "nǚ'ér", pt: "filha" },
    { hz: "小姐", py: "xiǎojiě", pt: "senhorita" },
    { hz: "衣服", py: "yīfu", pt: "roupa" },
    { hz: "水", py: "shuǐ", pt: "água" },
    { hz: "学校", py: "xuéxiào", pt: "escola" },
    { hz: "电影", py: "diànyǐng", pt: "filme" },
    { hz: "书", py: "shū", pt: "livro" },
    { hz: "四", py: "sì", pt: "quatro" },
    { hz: "五", py: "wǔ", pt: "cinco" },
    { hz: "医院", py: "yīyuàn", pt: "hospital" },
    { hz: "没关系", py: "méiguānxi", pt: "sem problemas / de nada" },
    { hz: "飞机", py: "fēijī", pt: "avião" },
    { hz: "二", py: "èr", pt: "dois" },
    { hz: "电视", py: "diànshì", pt: "TV" },
    { hz: "读", py: "dú", pt: "ler / estudar" },
    { hz: "后面", py: "hòumian", pt: "atrás" },
    { hz: "昨天", py: "zuótiān", pt: "ontem" },
    { hz: "睡觉", py: "shuìjiào", pt: "dormir" },
    { hz: "六", py: "liù", pt: "seis" },
    { hz: "老师", py: "lǎoshī", pt: "professor" },
    { hz: "星期", py: "xīngqī", pt: "semana" },
    { hz: "十", py: "shí", pt: "dez" },
    { hz: "猫", py: "māo", pt: "gato" },
    { hz: "电脑", py: "diànnǎo", pt: "computador" },
    { hz: "热", py: "rè", pt: "quente" },
    { hz: "学生", py: "xuésheng", pt: "estudante" },
    { hz: "下午", py: "xiàwǔ", pt: "tarde" },
    { hz: "学习", py: "xuéxí", pt: "estudar" },
    { hz: "冷", py: "lěng", pt: "frio" },
    { hz: "不客气", py: "búkèqi", pt: "não há de quê" },
    { hz: "前面", py: "qiánmian", pt: "frente" },
    { hz: "八", py: "bā", pt: "oito" },
    { hz: "中国", py: "Zhōngguó", pt: "China" },
    { hz: "七", py: "qī", pt: "sete" },
    { hz: "菜", py: "cài", pt: "prato / comida / vegetal" },
    { hz: "桌子", py: "zhuōzi", pt: "mesa" },
    { hz: "出租车", py: "chūzūchē", pt: "táxi" },
    { hz: "天气", py: "tiānqì", pt: "clima / tempo" },
    { hz: "茶", py: "chá", pt: "chá" },
    { hz: "九", py: "jiǔ", pt: "nove" },
    { hz: "商店", py: "shāngdiàn", pt: "loja" },
    { hz: "椅子", py: "yǐzi", pt: "cadeira" },
    { hz: "同学", py: "tóngxué", pt: "colega de classe" },
    { hz: "一点儿", py: "yīdiǎnr", pt: "um pouquinho" },
    { hz: "苹果", py: "píngguǒ", pt: "maçã" },
    { hz: "饭店", py: "fàndiàn", pt: "restaurante" },
    { hz: "中午", py: "zhōngwǔ", pt: "meio-dia" },
    { hz: "上午", py: "shàngwǔ", pt: "manhã" },
    { hz: "水果", py: "shuǐguǒ", pt: "fruta" },
    { hz: "杯子", py: "bēizi", pt: "copo" },
    { hz: "下雨", py: "xiàyǔ", pt: "chover" },
    { hz: "米饭", py: "mǐfàn", pt: "arroz cozido" },
    { hz: "北京", py: "Běijīng", pt: "Pequim" },
    { hz: "汉语", py: "Hànyǔ", pt: "Língua Chinesa" },
    { hz: "就", py: "jiù", pt: "então / justamente" },
    { hz: "要", py: "yào", pt: "querer / precisar / futuro" },
    { hz: "知道", py: "zhīdao", pt: "saber (fato)" },
    { hz: "吧", py: "ba", pt: "partícula de sugestão" },
    { hz: "到", py: "dào", pt: "chegar" },
    { hz: "对", py: "duì", pt: "correto / para" },
    { hz: "也", py: "yě", pt: "também" },
    { hz: "还", py: "hái", pt: "ainda / além disso" },
    { hz: "让", py: "ràng", pt: "deixar / permitir" },
    { hz: "给", py: "gěi", pt: "dar / para" },
    { hz: "过", py: "guò", pt: "passar / partícula de experiência" },
    { hz: "得", py: "de", pt: "partícula de complemento" },
    { hz: "真", py: "zhēn", pt: "realmente" },
    { hz: "着", py: "zhe", pt: "partícula de ação contínua" },
    { hz: "可以", py: "kěyǐ", pt: "poder / ser permitido" },
    { hz: "别", py: "bié", pt: "não (imperativo) / outro" },
    { hz: "走", py: "zǒu", pt: "andar / ir embora" },
    { hz: "告诉", py: "gàosu", pt: "contar / avisar" },
    { hz: "因为", py: "yīnwèi", pt: "porque" },
    { hz: "快", py: "kuài", pt: "rápido" },
    { hz: "但是", py: "dànshì", pt: "mas" },
    { hz: "已经", py: "yǐjīng", pt: "já" },
    { hz: "为什么", py: "wèishénme", pt: "por que?" },
    { hz: "觉得", py: "juéde", pt: "achar / sentir" },
    { hz: "它", py: "tā", pt: "ele/ela (para objetos/animais)" },
    { hz: "从", py: "cóng", pt: "de / a partir de" },
    { hz: "找", py: "zhǎo", pt: "procurar" },
    { hz: "最", py: "zuì", pt: "o mais (superlativo)" },
    { hz: "可能", py: "kěnéng", pt: "talvez / possível" },
    { hz: "次", py: "cì", pt: "vez (frequência)" },
    { hz: "出", py: "chū", pt: "sair" },
    { hz: "孩子", py: "háizi", pt: "criança / filho" },
    { hz: "所以", py: "suǒyǐ", pt: "por isso / então" },
    { hz: "两", py: "liǎng", pt: "dois (quantidade)" },
    { hz: "错", py: "cuò", pt: "errado" },
    { hz: "等", py: "děng", pt: "esperar" },
    { hz: "题", py: "tí", pt: "questão / tópico" },
    { hz: "问", py: "wèn", pt: "perguntar" },
    { hz: "问题", py: "wèntí", pt: "pergunta / problema" }
];